...
if st.button("📄 Generar PDF", type="primary"):
    pdf_buffer = generar_pdf_cubicacion(
        ...
        total_hormigon=st.session_state.get("total_hormigon", 0),
        total_sacos=st.session_state.get("total_sacos", 0),
        total_gravilla=st.session_state.get("total_gravilla", 0),
        total_arena=st.session_state.get("total_arena", 0),
        total_agua=st.session_state.get("total_agua", 0),
